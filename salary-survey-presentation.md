# Welcome
Using the data from a table of salary survey data, we will find the industries that are most welcoming to minorities by answering the following questions:   
